...
@Composable
public fun rememberGestureState(
    zoom: ZoomState? = null,
    drag: DragState? = null,
    tap: TapState? = null,
): GestureState {
...
public fun Modifier.onGestures(state: GestureState): Modifier {
    return this.then(
        pointerInput(Unit) {
            coroutineScope {
