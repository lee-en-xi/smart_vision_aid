...
import com.example.smart_vision_aid.cropUtils.containsInclusive
...
public fun calculateSampleSize(imgRegion: IntSize, view: IntSize): Int {
...
public fun DecodeParams.contains(other: DecodeParams): Boolean {
